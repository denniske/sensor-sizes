...
export default function Privacy() {
    ...
    return (
        <div className={classes.container}>
            ...
            <p>If you are located outside Germany and choose to provide information to us, please note that we transfer the data,
                ...
                <li>
                    ...
                    <p>Google Analytics is a web analytics service offered by Google that tracks and reports website traffic. Google
                        ...
                        network.<br/>
                            ...
                            For more information on the privacy practices of Google, please visit the Google Privacy Terms web page: <a
                            href="http://www.google.com/intl/en/policies/privacy/privacy.tsx">http://www.google.com/intl/en/policies/privacy/</a>
                    </p>
                </li>
            </ul>
